...
my $reporter = Bundle::Modules::Test::Reporter->new(
   ...
   'via' => 'Bundle::Modules::CPAN 2006.0604'
...
push( @module, 'Net::BitTorrent::LibBT::Tracker' );
...
push( @module, 'Catalyst::Model::Proxy' );
...
push( @module, 'SMS::Send::NL::Mollie' );
...
push( @module, 'Class::Meta::Express' );
...
push( @module, 'Syntax::Highlight::Engine::Kate' );
push( @module, 'SHA' );
...
push( @module, 'CGI::Cookie::Splitter' );
push( @module, 'Embperl' );
...
push( @module, 'SMS::Send::NL::MyVodafone' );
...
push( @module, 'HTTP::Cookies::Guess' );
...
push( @module, 'WebService::JugemKey::Auth' );
   ...
   if ( defined( $mist->extract() ) )
   {
      ...
      if ( -d '_dat' )
      {
         if ( ! -f $mist->extract().'/SIGNATURE' )
         {
            ...
            $xml_gz = '_dat/Bundle::Modules::CPAN::unsigned.xml.gz';
         ...
         $xml_gz = '_dat/Bundle::Modules::CPAN::prereqs.xml.gz';
      ...
      if ( ( $mist->signature() && $mist->checksum_ok() && -f $mist->extract().'/SIGNATURE' ) || ! $mist->created() )
      {
         if ( defined( $mist->extract() ) )
         {
            ...
            if ( -d '_dat' )
            {
               ...
               $xml_gz = '_dat/Bundle::Modules::CPAN.xml.gz';
