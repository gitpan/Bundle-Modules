...
=item C<% B<perl -MCPAN -e 'install Bundle::Modules::Acme::Everything::Unstable'>>

=item C<% B<cpan -i Bundle::Modules::Acme::Everything::Unstable>>
...
If you use the command C<B<man Bundle::Modules::Acme::Everything::Unstable>>, type C<B</#>> to see the commented out modules as they're higlighted for you by B<L<man>>.
